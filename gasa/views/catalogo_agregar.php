...
<form action="catalogo/agregar" method="post">
  ...
  <tr>
    ...
    <td width="31%" class="normales"><input name="codigo" type="text" id="codigo" value="<?php echo set_value('codigo'); ?>" size="40" /></td>
  ...
  <tr>
    ...
    <td class="normales"><input name="producto" type="text" id="producto" value="<?php echo set_value('producto'); ?>" size="40" /></td>
    <td class="normales"><?php echo form_error('producto'); ?></td>
  </tr>
  <tr>
    <td align="right" class="normales">Descripción:</td>
    <td class="normales"><textarea name="descripcion" cols="38" rows="4" id="descripcion"><?php echo set_value('descripcion'); ?></textarea></td>
...
-->
  <tr>
    ...
    </span></label><a href="catalogo"  style=" text-decoration:none;"><img src="images/btn_regresar.jpg"  border="0" align="absbottom"/></a></td>
  </tr>
</table>
</form>