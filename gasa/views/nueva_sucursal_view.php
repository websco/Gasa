...
<form action="sucursales/nuevo" method="post">
  ...
  <tr>
    <td><table width="480" border="0" cellpadding="0" cellspacing="5">
                          <tr align="left" valign="top">
                            ...
                            <td width="380"><input name="nombre"type="text" class="normales" id="unit_type"  size="39" maxlength="150" /></td>
                          </tr>
						   <tr align="left" valign="top">
                            <td align="left"><label class="normales">Direcci&oacute;n</label></td>
                            <td><label>
                              <textarea name="direccion" cols="36" id="direccion" class="normales"></textarea>
                            </label></td>
                          </tr>
						   <tr align="left" valign="top">
                            <td align="left"><label class="normales">Telefono</label></td>
                            <td><input name="telefono" type="text" class="normales" id="location"  size="39" maxlength="150" /></td>
                          </tr>                         
						  <tr align="left" valign="top">
