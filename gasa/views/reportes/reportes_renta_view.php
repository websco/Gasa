...
function cambiaStatus(codigo)
{
	$.jGrowl('Codigo Producto:'+codigo+' pasado a Devuelto',{
											...
											close: function(e,m,o) {
												window.location.replace("<?php echo base_url();?>"+"reportes/rentas"); 
												//window.location =<?php //echo base_url();?>+"reportes/rentas";
...
function toma_datos_impresion()
{
	...
	$("input[name='pfecha_renta']").val($('#fecha_renta').val());
return false;
}
...
<tr>
  ...
  <tr>
	...
	<div style="float:left; margin:10px; width:120px;"><a href="reportes/disponibles" style="text-decoration:none;"><img src="images/boton-disponibles.jpg" border="0"/></a></div>
      ...
      <tr>
        <td class="normales" >
			<form action="reportes/imprimir_rentados" method="post" name="form_print" target="_blank" style="width:250px;" onsubmit="toma_datos_impresion();" >
			Productos en renta: 
            <input type="image" src="images/79.png" width="16" height="16"  title="Imprimir Reporte" alt="Imprimir Reporte" />
			<input name="pfecha_renta" type="hidden" value="" />
  ...
  <tr>
    <td>
  <form action="reportes/rentas" method="post">
    <table width="96%" border="0" cellpadding="3" cellspacing="0">
	  <tr bgcolor="#666666">
        ...
        <td width="24%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Fecha Renta </div></td>
      ...
      <tr bgcolor="#666666">
        ...
        <td width="24%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><?php if($fecha_r =='' ){ ?>
          <input class="date-pick" name="fecha_renta" id="fecha_renta" type="text" size="12" style="width:70px;"/>
			<?php } else{ ?>
			 <input  class="date-pick" name="fecha_renta" id="fecha_renta" type="text" size="12" value="<?php echo $fecha_r;?>" style="width:70px;"/>
			<?php } ?></div>
</td>
        </tr>
</table>
	...
	<table width="96%" border="0" cellpadding="3" cellspacing="0">
      ...
      <tr class="normales_chicas">
        <td class="normales"><div class="button"><a href="javascript:;"   style=" text-decoration:none;" onclick="viewInfo('<? echo $producto->codigo; ?>',<?php echo $producto->status;?>);"><img src="images/ver.png" alt="ver detalles" width="16" height="17" style="cursor:pointer;" border="0"/></a></div></td>
        ...
        <td width="8%" class="normales"><div align="left"><?php if(($user['rol']==1)||($user['rol']==3)){?><a href="javascript:;"  onclick="cambiaStatus('<?php echo $producto->codigo;?>')"><input type="button" value="Devuelto" /></a><?php } ?> </div></td>
      </tr>
      <?php }}?>
	<tr><td>&nbsp;</td></tr>
    </table>    
