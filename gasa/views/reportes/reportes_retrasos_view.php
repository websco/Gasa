...
{
	$.jGrowl('Codigo Producto:'+codigo+' pasado a Devuelto',{
											beforeOpen: function(e,m,o) {
												$.post('reportes/cambiarPaDevuelto',{codigo:codigo}, function(data){
											...
											close: function(e,m,o) {
												window.location.replace("<?php echo base_url();?>"+"reportes/retrasos"); 
												//window.location ="reportes/retrasos";
...
function toma_datos_impresion()
{
	...
	$("input[name='pfecha_promesa']").val($('#fecha_promesa').val());
	$("input[name='pdias']").val($('#dias').val());
}
...
<tr>
  ...
  <tr>
	...
	<div style="float:left; margin:10px; width:120px;"><a href="reportes/disponibles" style="text-decoration:none;"><img src="images/boton-disponibles.jpg" border="0"/></a></div>
      ...
      <tr>
        <td class="normales" >
			<form action="reportes/imprimir_retrasos" method="post" name="form_print" target="_blank" style="width:250px;" onsubmit="toma_datos_impresion()" >
			Productos con retrasos: 
            <input type="image" src="images/79.png" width="16" height="16"  title="Imprimir Reporte" alt="Imprimir Reporte" />
			<input name="pfecha_promesa" type="hidden" value="" />
			<input name="pdias" type="hidden" value="" />
  ...
  <tr>
    <td>
  <form action="reportes/retrasos" method="post">
    <table width="96%" border="0" cellpadding="3" cellspacing="0">
	  <tr bgcolor="#666666">
        <td width="3%" bgcolor="#666666" class="normales_bold_blanco">&nbsp;</td>
        <td width="9%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Codigo</div></td>
        <td width="17%" bgcolor="#666666" class="normales_bold_blanco"><div align="left" style="margin-left:5px;">Producto</div></td>
        <td width="10%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Categoria</div></td>
        <td width="15%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Sucursal</div></td>
        <td width="20%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Fecha Promesa </div></td>
		 <td width="16%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Dias Retraso </div></td>
      ...
      <tr bgcolor="#666666">
        <td width="3%" bgcolor="#666666" class="normales_bold_blanco">&nbsp;</td>
        <td width="9%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">
          <label>
			<?php if($codigo =='' ){ ?>
        ...
        <td width="17%" bgcolor="#666666" class="normales_bold_blanco"><div align="left" style="margin-left:5px;">
																		<?php if($producto =='' ){ ?>
																	  <input name="producto" type="text" id="producto" size="15" />
																		<?php } else {?>
																		<input name="producto" type="text" id="producto" value="<?php echo $producto;?>" size="15" />
																		<?php } ?>
																	</div>
		</td>
        <td width="10%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><? if($categoria ==''){echo form_dropdown('categoria_id', $options_cat,'',"class='sel_categoria' id='categoria_id' style='size: 22.5em;width:70px;'");}else{echo form_dropdown('categoria_id', $options_cat,$categoria,"class='sel_categoria' id='categoria_id' style='size: 22.5em;width:70px;'");}?></div></td>
        <td width="15%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><? echo form_dropdown('sucursal_id', $options_suc,$sucursal,"class='sel_sucursal' id='sucursal_id' style='size: 22.5em;width:140px;'")?></div></td>
        <td width="20%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><?php if($fecha_p =='' ){ ?>
          <input class="date-pick" name="fecha_promesa" id="fecha_promesa" type="text" size="12" style="width:70px;"/>
			<?php } else{ ?>
			 <input class="date-pick" name="fecha_promesa" id="fecha_promesa" type="text" size="12" value="<?php echo $fecha_p;?>" style="width:70px;"/>
			<?php } ?></div>
		</td>
		 <td width="16%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><?php if($dias =='' ){ ?>
          <input  name="dias" id="dias" type="text" size="9" style="width:70px;"/>
			<?php } else{ ?>
			 <input  name="dias" id="dias" type="text" size="9" value="<?php echo $dias;?>" style="width:70px;"/>
			<?php } ?></div>
		</td>
        </tr>
</table>
	...
	<table width="96%" border="0" cellpadding="3" cellspacing="0">
      ...
      <tr class="normales_chicas">
        ...
        <td width="14%" class="normales"><div align="left"><?php echo $producto->codigo?></div></td>
        <td width="19%" class="normales"><div align="left"><?php echo $producto->nombre?></div></td>
        ...
        <td width="12%" class="normales"><div align="left"><?php echo date("d-m-Y",strtotime($producto->fecha_promesa));?></div></td>
		<td width="10%" class="normales"><div align="center"><?php echo $producto->dias;?></div><div align="center"></div></td>

        <td width="10%" class="normales"><div align="left"><?php if(($user['rol']==1)||($user['rol']==3)){?><a href="javascript:;"  onclick="cambiaStatus('<?php echo $producto->codigo;?>')"><input type="button" value="Devuelto" /></a><?php } ?> </div></td>
      </tr>
      <?php }}?>
	<tr><td>&nbsp;</td></tr>
    </table>   
