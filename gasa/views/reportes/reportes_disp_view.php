...
<tr>
  ...
  <tr>
	...
	<div style="float:left; margin:10px; width:120px;"><a href="reportes/disponibles" style="text-decoration:none;"><img src="images/boton-disponibles.jpg" border="0"/></a></div>
      ...
      <tr>
        <td class="normales" >
			<form action="reportes/imprimir_disponibles" method="post" name="form_print" target="_blank" style="width:280px;" onsubmit="toma_datos_impresion();" >
  ...
  <tr>
    <td>
  <form action="reportes/disponibles" method="post">
    <table width="96%" border="0" cellpadding="3" cellspacing="0">
	  <tr bgcolor="#666666">
        ...
        <td width="36%" bgcolor="#666666" class="normales_bold_blanco"><div align="left">Sucursal</div></td>
        <td width="12%" colspan="2" rowspan="2" bgcolor="#666666" class="normales_bold_blanco"> <div align="left"><input type="image" src="images/search2.png" width="32" height="32"  border="0" style="cursor:pointer;" alt="Buscar" name="buscar" id="button" value="Buscar" /></div></td>
        </tr>
      <tr bgcolor="#666666">
        <td width="4%" bgcolor="#666666" class="normales_bold_blanco">&nbsp;</td>
        ...
        <td width="36%" bgcolor="#666666" class="normales_bold_blanco"><div align="left"><?  echo form_dropdown('sucursal_id', $options_suc,$sucursal,"class='sel_sucursal' id='sucursal_id' style='size: 22.5em;width:140px;'");?></div></td>
        </tr>
</table>
</form>
	...
	<table width="96%" border="0" cellpadding="3" cellspacing="0">
      ...
      <tr class="normales_chicas">
        ...
        <td width="15%" class="normales"><div align="left"><?php echo $producto->codigo?></div></td>
        <td width="25%" class="normales"><div align="left"><?php echo $producto->nombre?></div></td>
		  <td width="13%" class="normales"><div align="left"><?php echo $producto->categoria?></div></td>
        <td width="41%" class="normales"><div align="left"><?php echo $producto->sucursal?></div></td>
